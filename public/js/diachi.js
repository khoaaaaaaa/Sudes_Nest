// Chọn địa chỉ bằng ajax
$(document).ready(function() {
    console.log("địa chỉ thnahf công");
    ...
    $('#province').on('change', function() {
      ...
      if (province_id) {
        ...
        $.ajax({
          url: '?mod=cart&controllers=index&action=ajax_get_district',
          method: 'GET',
          dataType: "json",
          data: {
    ...
    $('#district').on('change', function() {
      ...
      if (district_id) {
        ...
        $.ajax({
          url: '?mod=cart&controllers=index&action=ajax_get_wards',
          method: 'GET',
          dataType: "json",
          data: {
