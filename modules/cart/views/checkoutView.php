            ...
            <div class="min_wrap">
                        ...
                        <div class="cart_product_price">
                            <div class="section-head">
                                ...
                                <table>
                                    ...
                                    <td class="mobile"><strong><?php echo currency_format($item['price']) ?></strong><i> x<?php echo $item['qty']?></i> </td>
                ...
                <?php }else{?>
                    <div style="width:100%;text-align:center" class="anh">
                        <img style="width: 50%; height: 200px !important;" src="public/img/empty_cart.jpg" alt="">
                    </div>   
                <?php }?>         
            </div>
        </section>
