  ...
  <?php $order=get_ddh_by_id($id_ddh);?>
    <div class="container px-5">
        <div  style="line-height: 30px;background: #f9f9f9;" class="mail_checkout p-4">
             <div style="font-size: 20px;text-align:center"> <strong>Cảm ơn quý khách đã đặt hàng tại Sundes Nest</strong></div>
            <p>Sundes Nest rất vui thông báo đơn hàng <strong>#DH<?php echo $order['id_ddh']?></strong> của quý khách đã được tiếp nhận và đang trong quá trình xử lý, Sundes Nest sẽ thông báo đến quý khách ngay khi đơn hàng chuẩn bị được giao </p>
            ...
            <div><strong>Thời gian giao hàng dự kiến:</strong> Dự kiến giao hàng trong vòng từ 3 - 5 ngày</div>
                    ...
                    <tr class="">
                        ...
                        <td>
                           <?php 
                            ...
                            ?>
                            <a href="" title=""><img width="60px" style="display:block !important;"src=" cid:<?php echo $img?>" alt=""></a>
                        </td>
